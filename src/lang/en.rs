...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Pane Ratio", "Pane ratio"),
        ("Adjust Split Ratio", "Adjust split ratio"),
        ("Drag to Resize", "Drag to resize"),
        ("Remote IME", "Remote IME"),
        ("Text Injection", "Text injection"),
        ("Key Events", "Key events"),
        ("Use Remote IME", "Use remote IME"),
        ("Input Mode", "Input mode"),
        ("Trackpad", "Trackpad"),
        ("Trackpad Left", "Trackpad left"),
        ...
        ("Windows", "Windows"),
        ("Linux", "Linux"),
        ("Keyboard System Switch", "Keyboard system switch"),
        ("Language Settings", "Language settings"),
        ("Mac Language Switching", "Mac language switching"),
        ("Windows Language Switching", "Windows language switching"),
        ("Linux Language Switching", "Linux language switching"),
        ("Previous Input Source", "Previous input source"),
        ("Next in Input Menu", "Next in input menu"),
        ("Previous Language", "Previous language"),
        ...
        ("Mac modifier labels", "Mac modifier labels"),
        ("Windows modifier labels", "Windows modifier labels"),
        ("Linux modifier labels", "Linux modifier labels"),
        ("Capture Shortcut", "Capture shortcut"),
        ("No shortcut selected", "No shortcut selected"),
        ("Choose keys from System Keys layer", "Choose keys from System Keys layer"),
        ...
        ("Symbols", "Symbols"),
        ("More", "More"),
        ("Official Settings", "Official settings"),
