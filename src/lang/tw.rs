...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Input Pane", "輸入面板"),
        ("Pane Ratio", "面板比例"),
        ("Adjust Split Ratio", "調整分割比例"),
        ("Drag to Resize", "拖曳調整大小"),
        ("Remote IME", "遠端輸入法"),
        ("Text Injection", "文字注入"),
        ("Key Events", "按鍵事件"),
        ("Use Remote IME", "使用遠端輸入法"),
        ("Input Mode", "輸入模式"),
        ("Trackpad", "觸控板"),
        ("Trackpad Left", "觸控板在左側"),
        ("Trackpad Right", "觸控板在右側"),
        ("Display Mode", "顯示模式"),
        ("Contain", "適應"),
        ("Fill", "填滿"),
        ("Pan/Zoom", "平移/縮放"),
        ...
        ("Windows", "Windows"),
        ("Linux", "Linux"),
        ("Keyboard System Switch", "鍵盤系統切換"),
        ("Language Settings", "語言設定"),
        ("Mac Language Switching", "Mac 語言切換"),
        ("Windows Language Switching", "Windows 語言切換"),
        ("Linux Language Switching", "Linux 語言切換"),
        ("Previous Input Source", "在上個輸入來源之間切換"),
        ("Next in Input Menu", "輸入選單下一個"),
        ("Previous Language", "上一個語言"),
        ("Next Language", "下一個語言"),
        ("Prev Lang", "上個語言"),
        ("Next Lang", "下個語言"),
        ...
        ("Mac modifier labels", "Mac 修飾鍵名稱"),
        ("Windows modifier labels", "Windows 修飾鍵名稱"),
        ("Linux modifier labels", "Linux 修飾鍵名稱"),
        ("Capture Shortcut", "擷取快捷鍵"),
        ("No shortcut selected", "尚未選擇快捷鍵"),
        ("Choose keys from System Keys layer", "請從系統特殊鍵層選擇按鍵"),
        ("Resize panes", "調整面板比例"),
        ("Control", "Control"),
        ("Option", "Option"),
        ("Command", "Command"),
