...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Text Injection", "文本注入"),
        ("Key Events", "按键事件"),
        ("Use Remote IME", "使用远端输入法"),
        ("Input Mode", "输入模式"),
        ("Trackpad", "触控板"),
        ("Trackpad Left", "触控板在左侧"),
        ("Trackpad Right", "触控板在右侧"),
        ("Display Mode", "显示模式"),
        ("Contain", "适应"),
        ("Fill", "填充"),
        ("Pan/Zoom", "平移/缩放"),
        ...
        ("Windows", "Windows"),
        ("Linux", "Linux"),
        ("Keyboard System Switch", "键盘系统切换"),
        ("Language Settings", "语言设置"),
        ("Mac Language Switching", "Mac 语言切换"),
        ("Windows Language Switching", "Windows 语言切换"),
        ("Linux Language Switching", "Linux 语言切换"),
        ("Previous Input Source", "在上个输入源之间切换"),
        ("Next in Input Menu", "输入菜单下一个"),
        ("Previous Language", "上一个语言"),
        ("Next Language", "下一个语言"),
        ("Prev Lang", "上个语言"),
        ("Next Lang", "下个语言"),
        ("Set Previous Input Source Shortcut", "设置上个输入源快捷键"),
        ("Set Input Next Source In Input Menu Shortcut", "设置输入菜单下一个输入源快捷键"),
        ("Set Previous Language Shortcut", "设置上一个语言快捷键"),
        ("Set Next Language Shortcut", "设置下一个语言快捷键"),
        ("Modifier Display Style", "修饰键显示风格"),
        ("Mac modifier labels", "Mac 修饰键名称"),
        ("Windows modifier labels", "Windows 修饰键名称"),
        ("Linux modifier labels", "Linux 修饰键名称"),
        ("Capture Shortcut", "捕获快捷键"),
        ("No shortcut selected", "未选择快捷键"),
        ("Choose keys from System Keys layer", "请从系统特殊键层选择按键"),
        ("Resize panes", "调整面板比例"),
        ("Control", "Control"),
        ("Option", "Option"),
        ("Command", "Command"),
